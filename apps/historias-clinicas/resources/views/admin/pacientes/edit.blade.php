...
<div class="form-group">
        ...
        <form method="POST" action="{{ route("admin.paciente.update", [$Paciente->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 {{ $errors->has('tipo_egreso') ? 'is-invalid' : '' }}" name="tipo_egreso" id="tipo_egreso">
                                    ...
                                    <option value="Retiro" {{ old('tipo_egreso', $Paciente->ficha_admision->tipo_egreso) == 'Retiro' ? 'selected' : '' }}>Retiro</option>
                                    <option value="Fuga" {{ old('tipo_egreso', $Paciente->ficha_admision->tipo_egreso) == 'Fuga' ? 'selected' : '' }}>Fuga</option>
                                </select>
