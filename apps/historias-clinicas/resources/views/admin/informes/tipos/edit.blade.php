...
.it-id-badge {
    ...
    background: #f0f3f8; color: #1a3561;
...
<div class="it-form-wrap">
    ...
    <div class="it-card">
        ...
        <div class="it-card-body">
            ...
            <div class="it-id-badge">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" style="width:12px;height:12px;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14"/></svg>
                ID: {{ $InformeTipo->id }}
            </div>

            <form method="POST" action="{{ route('admin.informes.tipos.update', $InformeTipo->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="it-field">
                    ...
                    <input class="it-input {{ $errors->has('name') ? 'error' : '' }}"
                           ...
                           value="{{ old('name', $InformeTipo->name) }}"
                    ...
                    @enderror
                    <div class="it-hint">
                        Cambiá el nombre no afecta los informes ya cargados.
                    </div>
                </div>
