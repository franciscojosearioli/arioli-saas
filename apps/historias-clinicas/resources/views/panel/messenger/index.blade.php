...
<div class="msg-thread-list">
    @forelse($topics as $topic)
        ...
        <div class="msg-thread-row" style="display:flex;align-items:center;gap:12px;">
            ...
            <form action="{{ route('panel.messenger.destroyTopic', $topic->id) }}" method="POST"
                  onsubmit="return confirm('{{ trans('global.areYouSure') }}')">
                @csrf
                @method('DELETE')
                <button type="submit" class="msg-del-btn" title="Eliminar conversación">
