...
<style>
    /* ══════════════════════════════════════
       MESSENGER — layout & shared tokens
    ══════════════════════════════════════ */
    .msg-shell {
        display: grid;
    ...
    @@media (max-width: 768px) {
        ...
        .msg-shell.mob-sidebar .msg-sidebar { display: flex; }
        .msg-shell.mob-sidebar .msg-main    { display: none; }
    }
    ...
    <aside class="msg-sidebar">
        <div class="msg-sidebar-head">
            <div class="msg-sidebar-title">
                Mensajería
                <a href="{{ route('panel.messenger.createTopic') }}" class="msg-btn-new">
        ...
        <nav class="msg-nav">
            <a href="{{ route('panel.messenger.index') }}"
               class="msg-nav-link {{ request()->routeIs('panel.messenger.index') ? 'active' : '' }}">
            ...
            <a href="{{ route('panel.messenger.showInbox') }}"
               class="msg-nav-link {{ request()->routeIs('panel.messenger.showInbox') ? 'active' : '' }}">
                <span class="msg-nav-left">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @if(isset($unreads['inbox']) && $unreads['inbox'] > 0)
                    <span class="msg-badge">{{ $unreads['inbox'] }}</span>
                @endif
            </a>
            <a href="{{ route('panel.messenger.showOutbox') }}"
               class="msg-nav-link {{ request()->routeIs('panel.messenger.showOutbox') ? 'active' : '' }}">
                <span class="msg-nav-left">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @if(isset($unreads['outbox']) && $unreads['outbox'] > 0)
