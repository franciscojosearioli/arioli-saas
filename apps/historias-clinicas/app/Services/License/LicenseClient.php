...
{
    private const CACHE_TTL = 300; // 5 minutes, same as ValidateLicense
    ...
    public function isDemo(): bool    { return $this->getInfo()->isDemo(); }
    public function isActive(): bool  { return $this->getInfo()->active; }
    public function getType(): string { return $this->getInfo()->licenseType; }
