...
<head>
    ...
    <title>Contacto — Arioli.dev</title>
    <meta name="description" content="Escribinos tu consulta y te respondemos a la brevedad.">
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Form ── */
        .form-wrap { max-width: 560px; margin: 0 auto; padding: 0 32px 120px; }
...
<div class="page-header">
    ...
    <h1>Hablemos</h1>
    <p>Contanos tu consulta y te respondemos a la brevedad por email.</p>
</div>
...
<div class="form-wrap">
    <div class="form-card">
        ...
        <form method="POST" action="{{ route('landing.contact.send') }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea name="message" class="form-textarea" placeholder="Contanos en qué podemos ayudarte" required>{{ old('message') }}</textarea>
            </div>
