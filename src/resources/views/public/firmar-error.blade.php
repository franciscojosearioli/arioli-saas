    ...
    <div class="card">
        @php
            $messages = [
                ...
                'expired'           => 'Este link venció. Pedile al remitente que te reenvíe la solicitud de firma.',
                'already_signed'    => 'Este documento ya fue firmado — no hace falta hacer nada más.',
                'already_rejected'  => 'Ya rechazaste este documento previamente.',
            ];
        @endphp
