...
<body>
    <div class="container">
        <div class="header">
            <h1>Tu sistema de Turnos está listo</h1>
        </div>
        <div class="body">
            <p>Hola <strong>{{ $clientName }}</strong>,</p>
            <p>Tu plataforma de reservas y gestión de turnos ya está configurada y disponible. Podés acceder con las siguientes credenciales:</p>
            ...
            <p>Desde el sistema podés gestionar sucursales, servicios, recursos, empleados, clientes y la agenda de reservas.</p>
