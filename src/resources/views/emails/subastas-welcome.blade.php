...
<body>
    <div class="container">
        <div class="header">
            <h1>Tu plataforma de Subastas está lista</h1>
        </div>
        <div class="body">
            <p>Hola <strong>{{ $clientName }}</strong>,</p>
            <p>Tu plataforma de subastas judiciales electrónicas ya está configurada y disponible. Podés acceder con las siguientes credenciales:</p>
            ...
            <p>Desde el sistema vas a poder gestionar subastas, pujas en tiempo real, adjudicaciones y pagos.</p>
