...
<head>
    ...
    <style>
        ...
        .credentials { background: #f0f9ff; border: 1px solid #bae6fd; border-radius: 6px; padding: 20px; margin: 24px 0; }
        .credentials p { margin: 6px 0; font-size: 14px; }
        .credentials strong { color: #0369a1; }
        .btn { display: inline-block; background: #1e40af; color: #fff !important; text-decoration: none; padding: 12px 28px; border-radius: 6px; font-weight: bold; margin: 16px 0; }
...
<body>
    <div class="container">
        <div class="header">
            <h1>🏠 Tu sistema de Loteos está listo</h1>
        </div>
        <div class="body">
            <p>Hola <strong>{{ $clientName }}</strong>,</p>
            <p>Tu sistema de gestión de loteos ya está configurado y disponible. Podés acceder con las siguientes credenciales:</p>
