...
<body>
    <div class="container">
        <div class="header">
            <h1>Tu sistema Clínica está listo</h1>
        </div>
        <div class="body">
            <p>Hola <strong>{{ $clientName }}</strong>,</p>
            <p>Tu sistema de gestión de historias clínicas ya está configurado y disponible. Podés acceder con las siguientes credenciales:</p>
            ...
            <p>Desde el sistema podés gestionar pacientes, historias clínicas, informes, medicación y agenda.</p>
