...
<head>
    ...
    <title>Acceso Administrativo — Arioli.dev</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .admin-badge {
            ...
            letter-spacing: .06em; margin: 0 auto 20px; display: flex;
            justify-content: center; width: fit-content; margin: 0 auto 24px;
        }
    </style>
</head>
<body>
    <div class="card">
        ...
        <p class="subtitle">Solo para administradores de Arioli.dev</p>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group">
                ...
                <div class="password-wrap">
                    <input type="password" name="password" class="form-input"
                           placeholder="••••••••" required id="admin_password" autocomplete="current-password">
                    <button type="button" class="password-toggle" onclick="togglePassword('admin_password', this)">
            ...
            @if(config('services.turnstile.sitekey'))
                ...
                @error('cf-turnstile-response')
                    <p style="color:#f87171; font-size:12.5px; margin:-8px 0 16px;">{{ $message }}</p>
                @enderror
            @endif
